...
const TopBar = () => {
    return (
        <Box bg='black' w='100%' p={2}>
            ...
            <Container as={Flex} justifyContent="space-between" p={2} color='white' fontSize='xs'>
                ...
                <Flex gap="1.5rem">
                    ...
                    <Flex as={Link} href={''} display={{ base: 'none', sm: 'flex' }} alignItems='center' gap='0.5rem'><Image src={'/ico-small-location.svg'} alt={'ico-small-location'} width={24} height={24} />Ucraine, Kyiv, Khreshchatyk</Flex>

                    <Flex as={Link} href={''} display={{ base: 'none', sm: 'flex' }} alignItems='center' gap='0.5rem'><Image src={'/ico-small-clock.svg'} alt={'ico-small-clock'} width={24} height={24} />All week 24/7</Flex>
                </Flex>
